    ...
    <div class="main">
      ...
      <div class="project-info">
        ...
        <ul class="info-content">
          ...
          <!-- 填写凭证号 -->
          <li v-if="voucherNum"><strong>凭证号　</strong><span>{{voucherNum}}</span>
          </li>
          <li>
            <strong>有无发票</strong>
            <span>
      ...
      <div class="reimbursement">
        <h3>
          报销单据({{kindType}})
          <span @click="$router.push({path: 'PcompanyExpenseItemData', query: {businessKey:businessKey}})">查看详情>></span>
        </h3>
        <ul class="info-content">
          <!-- 差旅费才有 -->
