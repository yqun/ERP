  ...
  <div>
    <div class="main">
      ...
      <div>
        <h3>基本信息</h3>
        <group :gutter="0">
          <x-input disabled title="项目名称" :value="project.name"></x-input>
          <x-input disabled title="项目编号" :value="project.code"></x-input>
          <x-input disabled title="项目类型" :value="projectInfo.projectTypeText || ''"></x-input>
          <x-input disabled title="合作项目" :value="projectInfo.coopText || ''"></x-input>
          <x-input disabled title="业务员　" :value="salesman.chineseName"></x-input>
          <x-input disabled title="客户名称" :value="projectInfo.clientName"></x-input>
        </group>
      </div>
      <!-- 申请信息 -->
      <div>
