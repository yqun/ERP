  ...
  <div>
    <div class="main">
      ...
      <div>
        <h3>所需费用</h3>
        <group :gutter="0">
          <x-input disabled title="外包施工费" v-model="detailedTotal.constructionMoney"></x-input>
          <x-input disabled title="人工成本费" v-model="detailedTotal.serviceMoney"></x-input>
        </group>
      </div>
      <!-- 追加物品 -->
      <div class="cargo">
      ...
      <confirm v-model="confirmShow" title="货物清单" hide-on-blur :show-confirm-button="false" cancel-text="返回">
        ...
        <div class="table">
          <el-table :data="jsonProducts" height="500" style="width: 100%">
            ...
            <el-table-column prop="purchasingTaxRate" label="采购税率(%)" width="100"></el-table-column>
            <el-table-column prop="saleTaxRate" label="销售税率(%)" width="100"></el-table-column>
            <el-table-column prop="taxes" label="税金"></el-table-column>
            <el-table-column prop="grossProfit" label="毛利润"></el-table-column>
            <el-table-column prop="arrivalDateStr" label="到货时间" width="100"></el-table-column>
            <el-table-column prop="contacts" label="联系人"></el-table-column>
            <el-table-column prop="contactInfo" label="联系方式" width="140"></el-table-column>
